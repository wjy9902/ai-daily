...
3. 初始化 we-mp-rss：浏览器打开 `https://werss.<domain>`，用微信读书扫码
   ...
   2026-09-10 按在花频道（t.me/zaihuapd）引用出处再加六个：豆包 MP_WXS_3931663331、
   阿里云 MP_WXS_3086283381、智能涌现 MP_WXS_3900464567、千问AI平台 MP_WXS_3239545440、
   APPSO MP_WXS_2392024520、白鲸实验室 MP_WXS_3988375575，分成采集组 E（:50）和
   F（:55），当天手动 `/mps/update/{id}` 各拉一次验证过。
...
- **削峰比降频更重要，而 we-mp-rss 没有账号间延迟。** `jobs/mps.py` 的
  ...
  **12 号 × 4 轮 = 48 次/天（原 1728），最大突发 3（原 12）。**
  2026-09-10 加到 18 号后是组 A–F 各 3 号，`0 {0,15,30,45,50,55} 2,9,15,21`，72 次/天，
  突发仍是 3。
  02 点那轮喂 04:20 出刊，够用。
